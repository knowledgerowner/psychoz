...
export default function SecurityAlertTemplate({
  ...
  const getAlertColor = (type: string) => {
    switch (type) {
      case 'LOGIN_ATTEMPT': return '#0ea5e9';
      case 'PASSWORD_CHANGE': return '#0284c7';
      case '2FA_ENABLED': return '#0369a1';
      case '2FA_DISABLED': return '#0c4a6e';
      case 'SUSPICIOUS_ACTIVITY': return '#1e40af';
