      ...
      <div className="border rounded-lg p-4">
        ...
        <div className="border rounded overflow-hidden">
          <WelcomeTemplate
            ...
            activationLink="https://www.psychoz.fr/activate/abc123"
          />
        </div>
      </div>
      ...
      <div className="border rounded-lg p-4">
        ...
        <div className="border rounded overflow-hidden">
          <ArticlePublishedTemplate
            ...
            articleUrl="https://www.psychoz.fr/articles/introduction-nextjs-15"
      ...
      <div className="border rounded-lg p-4">
        ...
        <div className="border rounded overflow-hidden">
          <CommentReplyTemplate
            username="John Doe"
            commentUrl="https://www.psychoz.fr/articles/introduction-nextjs-15#comments"
            articleTitle="Introduction à Next.js 15 : Les Nouvelles Fonctionnalités"
      ...
      <div className="border rounded-lg p-4">
        ...
        <div className="border rounded overflow-hidden">
          <SecurityAlertTemplate
            ...
            securityUrl="https://www.psychoz.fr/profile/security"
          />
        </div>
      </div>
