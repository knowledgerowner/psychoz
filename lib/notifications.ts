...
async function sendArticlePublishedEmail(
  ...
  try {
    const subject = `Nouvel article publié : ${articleData.articleTitle} - Psychoz`;
...
function generateArticlePublishedEmailHTML(
  ...
  return `
    ...
    <head>
      ...
      <title>Nouvel article publié - Psychoz</title>
      <style>
        body { 
    ...
    <body>
      <div class="container">
        <div class="header">
          <h1 style="margin: 0; font-size: 32px;">📚 Psychoz</h1>
        ...
        <div class="content">
          ...
          <p>Cordialement,<br>L'équipe Psychoz</p>
        </div>
        
        <div class="footer">
          <p>&copy; 2024 Psychoz. Tous droits réservés.</p>
        </div>
...
export async function notifyCommentReply(
  ...
  try {
    ...
    if (user.notificationSettings?.emailNotifications?.commentReply) {
          const subject = `Nouvelle réponse à votre commentaire - Psychoz`;
...
function generateCommentReplyEmailHTML(
  ...
  return `
    ...
    <head>
      <meta charset="utf-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>Nouvelle réponse à votre commentaire - Psychoz</title>
      <style>
        body { 
          font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; 
          line-height: 1.6; 
...
export async function notifySecurityAlert(
  ...
  try {
    ...
    if (user.notificationSettings?.emailNotifications?.securityAlert) {
          const subject = `Alerte de sécurité - Psychoz`;
...
function generateSecurityAlertEmailHTML(
  ...
  return `
    ...
    <head>
      <meta charset="utf-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>Alerte de sécurité - Psychoz</title>
      <style>
        body { 
          font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; 
          line-height: 1.6; 
    ...
    <body>
      <div class="container">
        <div class="header">
          <h1 style="margin: 0; font-size: 32px;">${alertIcon} Psychoz</h1>
