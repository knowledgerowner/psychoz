...
export async function POST(request: NextRequest) {
  try {
    ...
    try {
      await sendEmail({
        to: user.email,
        subject: 'Réinitialisation de votre mot de passe - Psychoz',
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <p>Vous avez demandé la réinitialisation de votre mot de passe sur Psychoz.</p>
            ...
            <p style="color: #666; font-size: 12px; text-align: center;">
              Cet email a été envoyé automatiquement par Psychoz.<br>
