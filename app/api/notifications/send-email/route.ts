        ...
        htmlContent = `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 40px 20px; text-align: center;">
              <h1 style="margin: 0; font-size: 28px; font-weight: bold;">🎉 Bienvenue sur Psychoz !</h1>
            ...
            <div style="padding: 40px 20px; background-color: #ffffff;">
              ...
              <p style="color: #666; line-height: 1.6; margin-bottom: 20px;">Nous sommes ravis de vous accueillir dans la communauté Psychoz ! Vous faites maintenant partie d'une communauté passionnée de développeurs, experts en cybersécurité et passionnés de technologies.</p>
            ...
            <div style="background-color: #f8f9fa; padding: 30px 20px; text-align: center; border-top: 1px solid #e9ecef;">
              <p style="color: #666; margin: 0 0 15px 0;"><strong>Psychoz</strong> - Votre source de connaissances techniques</p>
