...
function getTwoFactorEmailSubject(type: 'LOGIN' | 'SETUP' | 'RESET'): string {
  switch (type) {
    case 'LOGIN':
      return 'Code de vérification pour votre connexion - Psychoz';
    case 'SETUP':
      return 'Code de vérification pour activer la 2FA - Psychoz';
    case 'RESET':
      return 'Code de vérification pour réinitialiser la 2FA - Psychoz';
    default:
      return 'Code de vérification - Psychoz';
  }
}
