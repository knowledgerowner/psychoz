      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-muted-foreground">
            Merci pour votre message. L&apos;équipe Psychoz vous répondra dans les plus brefs délais.
          </p>
          <Button
    ...
    <div className="mx-auto max-w-9xl px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
          ...
          dans vos projets psychologiques et répondre à toutes vos questions.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 ">
        ...
        <div className="space-y-6 col-span-1 lg:col-span-2 text-center lg:text-left">
          <Card className="border-2 border-primary/20">
            <CardContent className="p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button type="submit" disabled={loading} className="w-full bg-sky-200 hover:bg-sky-700 cursor-pointer" size="lg">
          ...
          <Card>
            <CardContent className="p-6">
              <h3 className="text-lg font-semibold mb-4 text-center xl:text-left">Pourquoi choisir Psychoz ?</h3>
              <div className="space-y-3 text-sm text-muted-foreground text-center xl:text-left">
                <p>✅ Expertise psychologique approfondie et mise à jour régulière</p>
                <p>✅ Réponse personnalisée et adaptée à vos besoins spécifiques</p>
                <p>✅ Accompagnement complet de la théorie à la pratique</p>
                <p>✅ Approches modernes et bonnes pratiques psychologiques</p>
          ...
          <Card className="border-2 border-primary/20 text-center lg:text-left">
            <CardContent className="p-6">
              ...
              <div className="prose prose-sm dark:prose-invert max-w-none text-center xl:text-left">
                <p className="mb-4">
                  Oxelya est une entreprise spécialisée dans les services numériques, créatrice de Psychoz, 
                  une plateforme de référence dédiée au partage de connaissances psychologiques et à l&apos;accompagnement 
                  des psychologues et passionnés dans leurs projets psychologiques.
                </p>
                
                <p className="mb-4">
                  Notre équipe d&apos;experts combine expertise psychologique et vision stratégique pour offrir 
                  des solutions complètes en psychologie clinique, sociale, opérations psychologiques et 
                  intelligence émotionnelle. Nous accompagnons nos clients de la théorie à la pratique.
                </p>

                <p className="mb-6">
                  Psychoz représente notre engagement envers la communauté psychologique : partager des ressources 
                  éducatives de qualité, des tutoriels pratiques et des insights psychologiques pour aider 
                  les psychologues de tous niveaux à exceller dans leur domaine.
                </p>
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <ul className="mt-1 space-y-1 text-muted-foreground">
                      ...
                      <li>• Opérations psychologiques</li>
                      <li>• Intelligence émotionnelle</li>
                    </ul>
                  </div>
                  <div>
                    <strong>Domaines maîtrisés :</strong>
                    <ul className="mt-1 space-y-1 text-muted-foreground">
                      <li>• Psychologie cognitive</li>
                      <li>• Techniques d&apos;influence</li>
      ...
      <div className="mt-16 prose prose-sm dark:prose-invert max-w-none">
        ...
        <p className="mb-4">
          ...
          Notre mission est de fournir des ressources éducatives de qualité, des tutoriels pratiques et des insights psychologiques 
          pour aider les psychologues à exceller dans leur domaine.
        </p>
        <p className="mb-4">
          Que vous soyez un étudiant en psychologie cherchant à maîtriser les fondamentaux, un professionnel expérimenté 
          explorant les dernières avancées en psychologie sociale, ou une organisation souhaitant améliorer 
          son approche psychologique, notre équipe d&apos;experts est là pour vous accompagner.
        </p>
        <p>
          ...
          des résultats exceptionnels dans tous vos projets psychologiques.
        </p>
      </div>
    </div>
  );
