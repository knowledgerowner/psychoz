      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {articles.length > 0 ? (
          <>
            ...
            />
            {/* Pagination personnalisée pour les catégories */}
            {totalPages > 1 && (
              <div className="flex justify-center items-center gap-2 mt-8">
                <Link href={`/categories/${slug}?page=${Math.max(1, pageNumber - 1)}`}>
                  <Button
                    variant="outline"
                    size="sm"
                ...
                <Link href={`/categories/${slug}?page=${Math.min(totalPages, pageNumber + 1)}`}>
                  <Button
                    variant="outline"
                    size="sm"
