    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-black">Vue de l&apos;article</h1>
            <p className="text-black">Gérez et visualisez les détails de l&apos;article</p>
          </div>
        </div>
      ...
      <Tabs defaultValue="overview" className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="text-sm font-medium text-black">Auteur</label>
                  <div className="flex items-center space-x-2">
                    <User className="h-4 w-4 text-gray-400" />
                    <p className="text-black">{article.user.username}</p>
                    <span className="text-gray-400">({article.user.email})</span>
                  </div>
                </div>
                <div>
                  <label className="text-sm font-medium text-black">Catégories</label>
                ...
                <div>
                  <label className="text-sm font-medium text-black">Créé le</label>
                  <div className="flex items-center space-x-2">
                ...
                <div>
                  <label className="text-sm font-medium text-black">Modifié le</label>
                  <div className="flex items-center space-x-2">
                    <Calendar className="h-4 w-4 text-gray-400" />
                    <p className="text-black">
              ...
              {article.excerpt && (
                <div>
                  <label className="text-sm font-medium text-black">Extrait</label>
                  <p className="text-black mt-1">{article.excerpt}</p>
                </div>
              )}
          ...
          <Card>
            ...
            <CardContent>
              <div className="prose max-w-none">
                <div 
                  className="text-black prose-invert max-w-none"
        ...
        <TabsContent value="seo" className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                <label className="text-sm font-medium text-black">Titre SEO</label>
                <p className="text-black mt-1">{article.seoTitle || 'Non défini'}</p>
              </div>
              <div>
                <label className="text-sm font-medium text-black">Description SEO</label>
                <p className="text-black mt-1">{article.seoDesc || 'Non définie'}</p>
              </div>
              <div>
                <label className="text-sm font-medium text-black">Mots-clés SEO</label>
                <p className="text-black mt-1">{article.seoKeywords || 'Non définis'}</p>
              </div>
                              {article.seoImg && (
                  <div>
                    <label className="text-sm font-medium text-black">Image SEO</label>
                  <div className="mt-2">
                    <Image
                      src={article.seoImg}
                      alt="SEO"
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-center justify-between p-3 border rounded-lg">
                 ...
                 <div className="flex items-center justify-between p-3 border rounded-lg">
                                     <div>
                    <p className="font-medium text-black">Payant</p>
                 ...
                 <div className="flex items-center justify-between p-3 border rounded-lg">
                                     <div>
                    <p className="font-medium text-black">Auto</p>
              ...
              {article.isPremium && article.premiumPrice && (
                <div className="p-3 border rounded-lg">
                  <p className="font-medium text-black">Prix premium</p>
              ...
              {article.isBilled && article.billedPrice && (
                <div className="p-3 border rounded-lg">
                  <p className="font-medium text-black">Prix payant</p>
                  <p className="text-2xl font-bold text-green-400">
                    {article.billedPrice}€
                  </p>
                </div>
